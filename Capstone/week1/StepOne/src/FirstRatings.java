...
public class FirstRatings {
    ...
    private HashMap<String, Integer> numberOfMoviesByDirector;
    private ArrayList<Rater> raters;
    private HashMap<String, Integer> numberOfRatingsByRater;

    public FirstRatings(){
        moviesInfo = new ArrayList<Movie>();
        numberOfMoviesByDirector = new HashMap<String, Integer>();
        raters = new ArrayList<Rater>();
        numberOfRatingsByRater = new HashMap<String, Integer>();
    }
    ...
    private void mapDirectorsToMoviesCount(){
...
//        }
    ...
    private void mapRatersToNumRatings(){
        //build a hashmap of directors and movies count
        for(Rater rater : raters){
